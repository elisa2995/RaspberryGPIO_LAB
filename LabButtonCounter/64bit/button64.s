...
// Initialization of maximum value of the counter and current and old levels of the pin
...
//If we detect a rising edge, we decrement the counter
// Rising edge(transition from 0 to 1): _|¯
	mov 	x23, x0				// x23=new level of the pin
	cmp	x23, #1		 		// x23=1 if the button has been pressed	
	bne 	readAgain
	cmp	x22, #0				
