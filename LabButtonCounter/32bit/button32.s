...
@ Initialization of the counter and of the current and old level of the pin
...
@ If a rising edge is detected, the counter is decremented
@ Rising edge(transition from 0 to 1): _|¯
	mov 	r8, r0				@ r8=new level of the pin
	cmp	r8, #1		 		@ r8=1 if the button has been pressed		
	cmpeq	r7, #0				
	bne	readAgain			@ if not rising edge
			
@ Print the value of the counter
	mov	r1, r6				@ counter value
	sub	r1, r1, #1			
	ldr	r0, messageAddr
	bl	printf
